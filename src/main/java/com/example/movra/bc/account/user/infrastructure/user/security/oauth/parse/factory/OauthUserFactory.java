package com.example.movra.bc.account.user.infrastructure.user.security.oauth.parse.factory;
...
import com.example.movra.bc.account.user.infrastructure.user.security.oauth.parse.google.GoogleOAuthUserInfoParser;
import com.example.movra.bc.account.user.infrastructure.user.security.oauth.parse.naver.NaverOAuthUserInfoParser;
