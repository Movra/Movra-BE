...
public class CompleteMorningTaskService {

    private final DailyPlanRepository dailyPlanRepository;
    private final CurrentUserQuery currentUserQuery;

    @Transactional
    public void complete(UUID dailyPlanId, UUID taskId) {
        ...
        dailyPlan.validateTaskType(TaskId.of(taskId), TaskType.MORNING);
        dailyPlan.completeTask(TaskId.of(taskId));
